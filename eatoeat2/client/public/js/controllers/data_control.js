...
app.controller('cook_register', ['$scope', '$http', '$location', '$cookieStore', '$timeout', '$base64', '$window', '$rootScope', 'cfpLoadingBar', '$localStorage', 'blockUI', function ($scope, $http, $location, $cookieStore, $timeout, $base64, $window, $rootScope, cfpLoadingBar, $localStorage, blockUI) {
    ...
    $scope.cook_login_check = function (cook_login) {
        ...
        $http({
            ...
            $localStorage.cook_name = response.data[0].cook_name;

            if (response.data[0].isApproved == "Approved") {
                $scope.vv = "Approved"
            }
            if (response.data[0].isApproved == "Un Appr") {
                $scope.vv = "Pending For Approval"
            }
            if (response.data[0].isApproved == "updated") {
                $scope.vv = "Pending For Approval"
            }
    ...
    $scope.food_details_fetch = function (food_edit_id, foods) {
        ...
        if (foods.food_isApproved == "Approved") {
...
app.controller('user_register', ['$scope', '$http', '$location', '$cookieStore', '$timeout', '$routeParams', '$base64', '$rootScope', 'cfpLoadingBar', 'Notification', '$route', '$localStorage', 'blockUI', function ($scope, $http, $location, $cookieStore, $timeout, $routeParams, $base64, $rootScope, cfpLoadingBar, Notification, $route, $localStorage, blockUI) {
    ...
    $scope.get_foods_for_listing = function () {
        ...
        $http({
            ...
            $scope.min_date_for_listing = new Date().toString();
            console.log('THIS IS  PREV DATE');
            console.log($scope.min_date_for_listing);
                ...
                navigator.geolocation.getCurrentPosition(function (p) {
                    ...
                    for (var i = 0; i < $scope.lat_long_coll.length; i++) {
                        ...
                        markerB = new google.maps.Marker({
                            ...
                            map: map,
                            icon: 'http://192.168.1.16:3000/uploads/q.png'
                        });
    ...
    var listing_foods_limit_base = 2;
    $scope.listing_foods_limit = 2;
                            ...
                            if (parseInt(inputValue) == num) {
                                ...
                                swal({
                                    ...
                                    function (inputValue) {
                                        console.log(parseInt(inputValue));
                                        $scope.y = {};
                                        $scope.y.user_contact_no = contact_no.user_contact_no;
